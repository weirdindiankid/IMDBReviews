...
(function(){
    ...
    (function() {
    var p = "3379548", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_3379548||'',
    GUID:window.ftGUID_3379548||'99999999999',
    confID:window.ftConfID_3379548||'0',
    ftReturn: window.ftReturn_3379548||'',
    keyword:window.ftKeyword_3379548||'',
    ftId:window.ftId_3379548||'',
    imp:window.ftImp3379548,
    ftImpId:window.ftImp3379548 && window.ftImp3379548.impID || '',
    campaignID:'98328',
    cID:'93411',
    pID:'3379548',
    creativeID:'2406942',
    ...
    extscript:[""],
    clickTags: ["http://servedby.flashtalking.com/click/8/98328;3379548;2406942;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.xfinity.com/learn/bundles/triple-play?dfaid=4053494&cmp=0&cid=4053494"],
    placementDescription:'FTCOMCASTBAUNEDDESKTOPNONSUB300x250',
    width:300,
    height:250,
    ...
    divID:'ftdiv3379548',
    phID:'ftpos3379548',
    frameID:'ftframe3379548',
    expID:'ftexpframe3379548',
    altImgID:'ftalt3379548',
    altText:'Click here',
    altImgTarget:'_blank',
    altimghref:'http://servedby.flashtalking.com/click/8/98328;3379548;2406942;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.xfinity.com/learn/bundles/triple-play?dfaid=4053494&cmp=0&cid=4053494',
    altImg:'http://servedby.flashtalking.com/imp/8/98328;3379548;204;gif;XfinityUS;FTCOMCASTBAUNEDDESKTOPNONSUB300x250/?',
    viewableImpressionURL:'http://servedby.flashtalking.com/imp/8/98328;3379548;271;pixel;XfinityUS;FTCOMCASTBAUNEDDESKTOPNONSUB300x250/?',
    stump:'http://servedby.flashtalking.com',
    jsurl:'http://cdn.flashtalking.com/xre/337/3379548/2406942/js/j-3379548-2406942.js',
    file:'http://cdn.flashtalking.com/93411/2406942/DIGI_GM_BDL_PLACQ_ENG_79SAC8ST199HOL267x24_GETNOW_X1DVR_HTML_300x250.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM:'http://cdn.flashtalking.com',
    statBaseURL:'http://stat8.flashtalking.com/reportV3/ft.stat?121670683-3379548;2406942;',
    adVis:false ? 1 : 0,
    centreAd:true,
    mvt:true,
    segment:window.ftSegment_3379548||'',
    segmentList:window.ftSegmentList_3379548||[],
    ...
    baggyFrameLimit:15,
    append:!!(window.ftImp3379548 && window.ftImp3379548.jsAppend),
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m3379548')&&/^https:/.test(document.getElementById('ftscript_m3379548').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m3379548'),
    ...
    qsVars:[
        ['ftguid', 'ftGUID_3379548'],
        ['ftcfid', 'ftConfID_3379548'],
        ['fttime', 'ftTimestamp_3379548'],
        ['ftsection', 'ftSection_3379548'],
        ['ftcustom', 'ftCustom_3379548'],
        ['ft_id', 'ftId_3379548'],
        ['ftimpid','ftImp3379548', 'impID']
    ]
};
